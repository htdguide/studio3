...
const RegisterPage = () => {
  ...
  const handleRegistration = async (e) => {
    ...
    try {
      ...
      // Save additional user information to Firestore, including email
      await setDoc(doc(firestore, 'users', user.email), {
        email,  // Explicitly include the email
        name,
        address,
        phoneNumber,
        userClass,
      ...
      navigate('/member'); // Navigate to the member page upon successful registration
    } catch (error) {
